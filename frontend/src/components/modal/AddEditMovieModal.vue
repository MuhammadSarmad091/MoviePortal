...
const validateForm = () => {
  ...
  // Use utility function for movie form validation
  const { isValid, errors: validationErrors } = validateMovieForm(form);
  
  // Apply validation errors
  errors.title = validationErrors.title || '';
  errors.description = validationErrors.description || '';
  errors.releaseDate = validationErrors.releaseDate || '';
  errors.posterUrl = validationErrors.posterUrl || '';
  errors.trailerUrl = validationErrors.trailerUrl || '';
